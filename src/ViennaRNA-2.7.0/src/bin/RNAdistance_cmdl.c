/*
  ...
  /usr/bin/gengetopt -i RNAdistance.ggo --file-name=RNAdistance_cmdl --include-getopt --default-optional --func-name=RNAdistance_cmdline_parser --arg-struct-name=RNAdistance_args_info
