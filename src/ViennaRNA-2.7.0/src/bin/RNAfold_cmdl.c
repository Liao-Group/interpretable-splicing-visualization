...
init_full_help_array(void)
{
  ...
  RNAfold_args_info_full_help[28] = RNAfold_args_info_detailed_help[44];
  ...
  RNAfold_args_info_full_help[31] = RNAfold_args_info_detailed_help[49];
  RNAfold_args_info_full_help[32] = RNAfold_args_info_detailed_help[51];
  RNAfold_args_info_full_help[33] = RNAfold_args_info_detailed_help[52];
  ...
  RNAfold_args_info_full_help[40] = RNAfold_args_info_detailed_help[61];
  RNAfold_args_info_full_help[41] = RNAfold_args_info_detailed_help[62];
  RNAfold_args_info_full_help[42] = RNAfold_args_info_detailed_help[64];
  ...
  RNAfold_args_info_full_help[45] = RNAfold_args_info_detailed_help[70];
  ...
  RNAfold_args_info_full_help[48] = RNAfold_args_info_detailed_help[73];
  ...
  RNAfold_args_info_full_help[58] = RNAfold_args_info_detailed_help[88];
  RNAfold_args_info_full_help[59] = RNAfold_args_info_detailed_help[89];
  RNAfold_args_info_full_help[60] = RNAfold_args_info_detailed_help[91];
  RNAfold_args_info_full_help[61] = RNAfold_args_info_detailed_help[93];
  RNAfold_args_info_full_help[62] = RNAfold_args_info_detailed_help[95];
  RNAfold_args_info_full_help[63] = RNAfold_args_info_detailed_help[97];
  RNAfold_args_info_full_help[64] = RNAfold_args_info_detailed_help[98];
  RNAfold_args_info_full_help[65] = RNAfold_args_info_detailed_help[99];
  RNAfold_args_info_full_help[66] = RNAfold_args_info_detailed_help[100];
  RNAfold_args_info_full_help[67] = RNAfold_args_info_detailed_help[102];
  RNAfold_args_info_full_help[68] = RNAfold_args_info_detailed_help[104];
  RNAfold_args_info_full_help[69] = 0; 
  
}

const char *RNAfold_args_info_full_help[70];
...
init_help_array(void)
{
  ...
  RNAfold_args_info_help[13] = RNAfold_args_info_detailed_help[36];
  RNAfold_args_info_help[14] = RNAfold_args_info_detailed_help[37];
  RNAfold_args_info_help[15] = RNAfold_args_info_detailed_help[38];
  RNAfold_args_info_help[16] = RNAfold_args_info_detailed_help[44];
  RNAfold_args_info_help[17] = RNAfold_args_info_detailed_help[46];
  RNAfold_args_info_help[18] = RNAfold_args_info_detailed_help[51];
  RNAfold_args_info_help[19] = RNAfold_args_info_detailed_help[52];
  RNAfold_args_info_help[20] = RNAfold_args_info_detailed_help[53];
  RNAfold_args_info_help[21] = RNAfold_args_info_detailed_help[54];
  RNAfold_args_info_help[22] = RNAfold_args_info_detailed_help[55];
  RNAfold_args_info_help[23] = RNAfold_args_info_detailed_help[60];
  RNAfold_args_info_help[24] = RNAfold_args_info_detailed_help[61];
  RNAfold_args_info_help[25] = RNAfold_args_info_detailed_help[64];
  RNAfold_args_info_help[26] = RNAfold_args_info_detailed_help[70];
  RNAfold_args_info_help[27] = RNAfold_args_info_detailed_help[71];
  RNAfold_args_info_help[28] = RNAfold_args_info_detailed_help[72];
  RNAfold_args_info_help[29] = RNAfold_args_info_detailed_help[73];
  RNAfold_args_info_help[30] = RNAfold_args_info_detailed_help[77];
  RNAfold_args_info_help[31] = RNAfold_args_info_detailed_help[78];
  RNAfold_args_info_help[32] = RNAfold_args_info_detailed_help[80];
  RNAfold_args_info_help[33] = RNAfold_args_info_detailed_help[81];
  RNAfold_args_info_help[34] = RNAfold_args_info_detailed_help[82];
  RNAfold_args_info_help[35] = RNAfold_args_info_detailed_help[83];
  RNAfold_args_info_help[36] = RNAfold_args_info_detailed_help[85];
  RNAfold_args_info_help[37] = RNAfold_args_info_detailed_help[97];
  RNAfold_args_info_help[38] = RNAfold_args_info_detailed_help[98];
  RNAfold_args_info_help[39] = RNAfold_args_info_detailed_help[99];
  RNAfold_args_info_help[40] = RNAfold_args_info_detailed_help[100];
  RNAfold_args_info_help[41] = RNAfold_args_info_detailed_help[104];
...
void init_args_info(struct RNAfold_args_info *args_info)
{
  ...
  args_info->partfunc_help = RNAfold_args_info_detailed_help[38] ;
  args_info->betaScale_help = RNAfold_args_info_detailed_help[40] ;
  args_info->pfScale_help = RNAfold_args_info_detailed_help[42] ;
  ...
  args_info->maxBPspan_help = RNAfold_args_info_detailed_help[54] ;
  args_info->constraint_help = RNAfold_args_info_detailed_help[55] ;
  args_info->batch_help = RNAfold_args_info_detailed_help[57] ;
  args_info->canonicalBPonly_help = RNAfold_args_info_detailed_help[59] ;
  args_info->enforceConstraint_help = RNAfold_args_info_detailed_help[60] ;
  args_info->shape_help = RNAfold_args_info_detailed_help[61] ;
  args_info->shapeMethod_help = RNAfold_args_info_detailed_help[62] ;
  args_info->shapeConversion_help = RNAfold_args_info_detailed_help[64] ;
  args_info->motif_help = RNAfold_args_info_detailed_help[66] ;
  args_info->commands_help = RNAfold_args_info_detailed_help[68] ;
  args_info->temp_help = RNAfold_args_info_detailed_help[72] ;
  args_info->paramFile_help = RNAfold_args_info_detailed_help[73] ;
  args_info->noTetra_help = RNAfold_args_info_detailed_help[75] ;
  args_info->salt_help = RNAfold_args_info_detailed_help[77] ;
  args_info->modifications_help = RNAfold_args_info_detailed_help[78] ;
  args_info->mod_file_help = RNAfold_args_info_detailed_help[80] ;
  args_info->mod_file_min = 0;
  args_info->mod_file_max = 0;
  args_info->dangles_help = RNAfold_args_info_detailed_help[83] ;
  args_info->noLP_help = RNAfold_args_info_detailed_help[85] ;
  args_info->noGU_help = RNAfold_args_info_detailed_help[87] ;
  args_info->noClosingGU_help = RNAfold_args_info_detailed_help[88] ;
  args_info->nsp_help = RNAfold_args_info_detailed_help[89] ;
  args_info->energyModel_help = RNAfold_args_info_detailed_help[91] ;
  args_info->helical_rise_help = RNAfold_args_info_detailed_help[93] ;
  args_info->backbone_length_help = RNAfold_args_info_detailed_help[95] ;
  args_info->noPS_help = RNAfold_args_info_detailed_help[99] ;
  args_info->noDP_help = RNAfold_args_info_detailed_help[100] ;
  args_info->layout_type_help = RNAfold_args_info_detailed_help[102] ;
