...
init_full_help_array(void)
{
  ...
  RNAsubopt_args_info_full_help[45] = RNAsubopt_args_info_detailed_help[67];
  ...
  RNAsubopt_args_info_full_help[58] = RNAsubopt_args_info_detailed_help[86];
  ...
  RNAsubopt_args_info_full_help[63] = RNAsubopt_args_info_detailed_help[94];
  RNAsubopt_args_info_full_help[64] = RNAsubopt_args_info_detailed_help[96];
  RNAsubopt_args_info_full_help[65] = RNAsubopt_args_info_detailed_help[98];
  RNAsubopt_args_info_full_help[66] = RNAsubopt_args_info_detailed_help[100];
  RNAsubopt_args_info_full_help[67] = RNAsubopt_args_info_detailed_help[102];
  RNAsubopt_args_info_full_help[68] = 0; 
  
}

const char *RNAsubopt_args_info_full_help[69];
...
init_help_array(void)
{
  ...
  RNAsubopt_args_info_help[27] = RNAsubopt_args_info_detailed_help[66];
  RNAsubopt_args_info_help[28] = RNAsubopt_args_info_detailed_help[73];
  RNAsubopt_args_info_help[29] = RNAsubopt_args_info_detailed_help[74];
  RNAsubopt_args_info_help[30] = RNAsubopt_args_info_detailed_help[75];
  RNAsubopt_args_info_help[31] = RNAsubopt_args_info_detailed_help[76];
  ...
  RNAsubopt_args_info_help[34] = RNAsubopt_args_info_detailed_help[83];
  RNAsubopt_args_info_help[35] = RNAsubopt_args_info_detailed_help[84];
  RNAsubopt_args_info_help[36] = RNAsubopt_args_info_detailed_help[85];
  RNAsubopt_args_info_help[37] = RNAsubopt_args_info_detailed_help[86];
  RNAsubopt_args_info_help[38] = RNAsubopt_args_info_detailed_help[88];
  RNAsubopt_args_info_help[39] = RNAsubopt_args_info_detailed_help[92];
  RNAsubopt_args_info_help[40] = RNAsubopt_args_info_detailed_help[102];
...
void init_args_info(struct RNAsubopt_args_info *args_info)
{
  ...
  args_info->shape_help = RNAsubopt_args_info_detailed_help[66] ;
  args_info->shapeMethod_help = RNAsubopt_args_info_detailed_help[67] ;
  args_info->shapeConversion_help = RNAsubopt_args_info_detailed_help[69] ;
  args_info->commands_help = RNAsubopt_args_info_detailed_help[71] ;
  args_info->temp_help = RNAsubopt_args_info_detailed_help[75] ;
  args_info->paramFile_help = RNAsubopt_args_info_detailed_help[76] ;
  args_info->noTetra_help = RNAsubopt_args_info_detailed_help[78] ;
  args_info->salt_help = RNAsubopt_args_info_detailed_help[80] ;
  args_info->modifications_help = RNAsubopt_args_info_detailed_help[81] ;
  args_info->mod_file_help = RNAsubopt_args_info_detailed_help[83] ;
  args_info->mod_file_min = 0;
  args_info->mod_file_max = 0;
  args_info->dangles_help = RNAsubopt_args_info_detailed_help[86] ;
  args_info->noLP_help = RNAsubopt_args_info_detailed_help[88] ;
  args_info->noGU_help = RNAsubopt_args_info_detailed_help[90] ;
  args_info->noClosingGU_help = RNAsubopt_args_info_detailed_help[91] ;
  args_info->logML_help = RNAsubopt_args_info_detailed_help[92] ;
  args_info->nsp_help = RNAsubopt_args_info_detailed_help[94] ;
  args_info->energyModel_help = RNAsubopt_args_info_detailed_help[96] ;
  args_info->helical_rise_help = RNAsubopt_args_info_detailed_help[98] ;
  args_info->backbone_length_help = RNAsubopt_args_info_detailed_help[100] ;
