...
init_full_help_array(void)
{
  ...
  ct2db_args_info_full_help[9] = ct2db_args_info_detailed_help[10];
  ct2db_args_info_full_help[10] = ct2db_args_info_detailed_help[11];
  ct2db_args_info_full_help[11] = 0; 
  
}

const char *ct2db_args_info_full_help[12];
...
init_help_array(void)
{
  ...
  ct2db_args_info_help[7] = 0; 
  
}

const char *ct2db_args_info_help[8];
...
void init_args_info(struct ct2db_args_info *args_info)
{
  ...
  args_info->log_level_help = ct2db_args_info_detailed_help[7] ;
  args_info->log_file_help = ct2db_args_info_detailed_help[9] ;
  args_info->log_time_help = ct2db_args_info_detailed_help[10] ;
  args_info->log_call_help = ct2db_args_info_detailed_help[11] ;
